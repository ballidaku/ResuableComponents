package ballidaku.resuablecomponents.myLocation;
...
import ballidaku.resuablecomponents.databinding.ActivityGetLocationBinding;
          ...
          LocationListener
{
    ...
    private ActivityGetLocationBinding mBinding;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
       ...
       // setContentView(R.layout.activity_get_location);
        ...
        mBinding = DataBindingUtil.setContentView(this, R.layout.activity_get_location);
    ...
    protected void stopLocationUpdates()
    {
        ...
        LocationServices.FusedLocationApi.removeLocationUpdates(mGoogleApiClient, GetLocation.this);
    }
        ...
        switch (requestCode)
        {
            case PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION:
            {
                ...
                else
                {
                    ...
                    {
                        mRequestingLocationUpdates = false;
                        Toast.makeText(GetLocation.this, "To enable the function of this application please enable location permission of the application from the setting screen of the terminal.", Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
                        showRationaleDialog();
    ...
    private void showRationaleDialog()
    {
        new AlertDialog.Builder(this)
                  ...
                  .setNegativeButton("しない", new DialogInterface.OnClickListener()
                  {
                      ...
                      public void onClick(DialogInterface dialog, int which)
                      {
                          Toast.makeText(GetLocation.this, "Position information permission was not allowed.", Toast.LENGTH_SHORT).show();
                          mRequestingLocationUpdates = false;
                      }
                  })
                  .setCancelable(false)
