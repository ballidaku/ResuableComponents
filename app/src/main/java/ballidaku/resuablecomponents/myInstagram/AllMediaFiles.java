...
import ballidaku.resuablecomponents.myInstagram.adapter.MyGridListAdapter;
...
public class AllMediaFiles extends Activity
{
    ...
    private ArrayList<HashMap<String,String>> mainList = new ArrayList<>();
...
//https://api.instagram.com/v1/users/self/media/recent?access_token=1507971356.2153477.cf8ba3f0fd494d5d815d42da3d6d983a
                    ...
                    JSONObject jsonObject = jsonParser
                              .getJSONFromUrlByGet("https://api.instagram.com/v1/users/self/media/recent?access_token="
                                        + new InstagramSession(context).getAccessToken());
